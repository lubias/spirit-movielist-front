    ...
    return (
        ...
        >
            <div className="w-60 sm_1:w-full h-[420px] rounded-lg bg-black-06">
                <img src={`${configuration.base_url}${configuration.poster_sizes[3]}${serie.poster_path}`} alt={`Pôster de ${serie.name}`} className='w-full h-[360px] rounded-t-lg' />
                <div className='p-4'>
